...
% --- INICIO DE ELEMENTOS PRELIMINARES ---

% Para IEEEtran, el abstract y keywords van en un entorno específico
\begin{abstract}
...
% Se añade el Resumen como una sección sin numerar
\section*{Resumen}
...
% Se añade el Índice
\tableofcontents
\newpage % Se fuerza una nueva página después del índice para claridad
